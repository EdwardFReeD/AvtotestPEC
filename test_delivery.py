...
def delivery():
    # try:
        ...
        if WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.CLASS_NAME,
            ...
            elem2 = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.CLASS_NAME,
            ...
            if WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,
            ...
            elif WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,
